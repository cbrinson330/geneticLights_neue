...
if __name__ == "__main__":
    ...
    path, dirs, files = next(os.walk(patternStorageDir))
    fileCount = len(files)
    if(fileCount != numberOfPatterns):
       patternGen.genPatterns(numberOfPatterns, playTime, stepTime, numberOfLeds, patternStorageDir) 
